...
import { StarFilled, RightOutlined, LockFilled, CaretRightFilled } from "@ant-design/icons";
...
const DetailMidjourneyPrompt = () => {
  ...
  const showVariableDescription = (index) => {
    const descriptions = document.querySelectorAll('.detail-prompt-section-content-exampleVariables-description');
  ...
  const getDetailPrompt = async (id) => {
    try {
      ...
      const examplePromptsData = listDetail?.filter(item => item.type === 1) || [];
      const exampleVariablesData = listDetail?.filter(item => item.type === 2) || [];
    ...
    <div className="detail-prompt-component">
      <div className="detail-prompt-container">
        <div className="detail-prompt-content">
                ...
                {exampleVariables.map((variable, index) => (
                  <div key={index} className="detail-prompt-exampleVariables">
                    ...
                    {expandedVariables[index] && (
                      <div className="detail-prompt-section-content-exampleVariables-description"
                        style={{
              ...
              <div className="detail-prompt-section-content-examplePrompts">
                {examplePrompts.map((promptMid, index) => (
                  <div className="component-prompt-card-container-examplePrompts">
                    <div className="component-prompt-card-midjourney" style={{ background: `url(${promptMid.image})` }}>
                    ...
                    <div className="component-prompt-card-topic" style={{
                      position: "relative", 
                      bottom: 0, 
                      width: "100%",
                      marginTop: "auto",
          ...
          {prompt.how && <div className="detail-prompt-section" onClick={() => toggleSection('howToUse')}>
            <div className="detail-prompt-section-header">
              <div className="detail-prompt-section-title">
          ...
          {prompt.addtip && <div className="detail-prompt-section" onClick={() => toggleSection('additionalTips')}>
            <div className="detail-prompt-section-header">
              <div className="detail-prompt-section-title">
          ...
          {prompt.addinformation && <div className="detail-prompt-section" onClick={() => toggleSection('additionalInfo')}>
            <div className="detail-prompt-section-header">
              <div className="detail-prompt-section-title">
